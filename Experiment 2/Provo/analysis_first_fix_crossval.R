...
res_logRT$per_fold
res_logRT$summary
write.csv(res_logRT$summary, file = "../RT_analysis_all/data/Provo_logRT_first_fix_deltaLL_crossval.csv", row.names = FALSE)
...
write.csv(res_logRT_allsurp$summary, file = "../RT_analysis_all/data/Provo_logRT_allsurp_first_fix_deltaLL_crossval.csv", row.names = FALSE)
